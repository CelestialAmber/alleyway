...
Set up the repository.
	...
	git clone https://github.com/CelestialAmber/alleyway
	cd alleyway

To build `alleyway.gb`:
...
To compare the built `alleyway.gb` to the original ROM:
...
Then set up the repository. In the **Cygwin terminal**:
	...
	git clone https://github.com/CelestialAmber/alleyway.git
	cd alleyway
